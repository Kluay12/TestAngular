function section_manage_pending_posts_1407695292801905() {
    ...
    function reject_post(edges_obj) {
        ...
        var variables = JSON.stringify({
            "input": {
                "admin_notes": "กรุณาใส่ #DevasPay *หรือ QR Code ของท่าน ในข้อความ พร้อมกับการโพสต์ทุกครั้ง (ใส่ตรงไหนก็ได้) // เพื่อร่วมทดสอบ การป้องกันสแปม ในกลุ่มฯ ",
                "group_id": "1407695292801905",
                "selected_rules": [
                    "2384135101824581"
                ],
